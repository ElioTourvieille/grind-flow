  ...
  return (
    <>
      ...
      <aside
        id="nav-menu-4"
        aria-label="Side navigation"
        className={`fixed top-0 bottom-0 left-0 z-40 flex w-72 flex-col border-r border-r-border bg-[#1A1A1A] transition-transform lg:translate-x-0 ${
        ...
        >
          <ul className="flex flex-1 flex-col gap-1">
            <li>
              <a
                href="#"
                className="flex items-center gap-3 rounded-xl p-3 text-sm bg-emerald-800 text-emerald-300 transition-colors"
              >
                ...
                <div className="flex w-full flex-1 flex-col items-start justify-center gap-0 overflow-hidden truncate">
                  Dashboard
                </div>
              </a>
            </li>
            <li>
              <a
                href="#"
                className="flex items-center gap-3 rounded p-3 text-sm text-[#E0E0E0] transition-colors hover:bg-emerald-800/30"
              >
                <div className="flex items-center self-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
